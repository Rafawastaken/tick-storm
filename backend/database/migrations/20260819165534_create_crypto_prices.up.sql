...
CREATE INDEX idx_crypto_prices_lookup ON crypto_prices (exchange, coin_symbol, created_at DESC, id DESC);
...
CREATE UNIQUE INDEX uq_crypto_prices_trade ON crypto_prices (exchange, coin_symbol, trade_id)
WHERE
